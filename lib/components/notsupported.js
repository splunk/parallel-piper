  ...
  return (
    <div className="not-supported">
      <div className="item">
        ...
        <p>
          It seems like your device does not support the necessary APIs for this
          demo application to work. In particular the application listens to{" "}
          <code>ondevicemotion</code> events, which doesn't seem to be supported
          in your browser.
        </p>
